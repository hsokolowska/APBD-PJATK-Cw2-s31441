...
public sealed class ZadaniaLinq
{
    ...
    {
        var rezultat = DaneUczelni.Studenci.Where(stud => stud.Miasto == "Warsaw").Select(stud =>
            $"{stud.NumerIndeksu}" +
            $"{stud.Imie}" + $"{stud.Nazwisko}" + $"{stud.Miasto}");
        return rezultat;
    }
    ...
    {
        var rezultat = DaneUczelni.Studenci
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        var rezultat = przedmiot != null
            ? new[] { $"{przedmiot.Nazwa} {przedmiot.DataStartu:yyyy-MM-dd}" }
            : new[] { "Brak przedmiotu z kategorii Analytics." };
        return rezultat;
    }
    ...
    {
        var czyIstnieje = DaneUczelni.Zapisy
            .Any(z => !z.CzyAktywny);

        return new[] { $"Czy istnieje nieaktywny zapis: {(czyIstnieje ? "Tak" : "Nie")}" };
    }
    ...
    {
        var rezultat = DaneUczelni.Zapisy
    ...
    {
        var rezultat = DaneUczelni.Przedmioty
            .OrderBy(p => p.Nazwa)
            .Skip(2)
            .Take(2)
    ...
    public IEnumerable<string> Zadanie11_PolaczStudentowIZapisy()
    {
        var rezultat = DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy,
                stud => stud.Id,
                z => z.StudentId,
                (stud, z) => $"{stud.Imie} {stud.Nazwisko} {z.DataZapisu:yyyy-MM-dd}");
        return rezultat;
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        var rezultat = DaneUczelni.Studenci
            .SelectMany(
                stud => DaneUczelni.Zapisy.Where(z => z.StudentId == stud.Id),
                (stud, z) => new { stud, z })
            .Join(DaneUczelni.Przedmioty,
                para => para.z.PrzedmiotId,
                p => p.Id,
                (para, p) => $"{para.stud.Imie} {para.stud.Nazwisko} {p.Nazwa}");
        return rezultat;
    }
    ...
    {
        var rezultat = DaneUczelni.Prowadzacy
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        var rezultat = DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci,
                z => z.StudentId,
                stud => stud.Id,
                (z, stud) => new { stud.Imie, stud.Nazwisko, z.OcenaKoncowa })
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} Max ocena: {g.Max(x => x.OcenaKoncowa)}");
        return rezultat;
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        var rezultat = DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci,
                z => z.StudentId,
                stud => stud.Id,
                (z, stud) => new { stud.Imie, stud.Nazwisko })
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Where(g => g.Count() > 1)
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        var rezultat = DaneUczelni.Przedmioty
            ...
            .GroupJoin(DaneUczelni.Zapisy,
                p => p.Id,
                z => z.PrzedmiotId,
                (p, zapisy) => new { p.Nazwa, Zapisy = zapisy })
